...
def test_loan
  ...
  result_person1 = @people[0][:monies]
  result_person2 = @people[1][:monies]
  assert_equal(0, result_person1)
  assert_equal(3, result_person2)
end
...
def test_everyones_favourite_food
  ...
  everyones_food = ["charcuterie", "soup","bread", "Scooby snacks", "spaghetti", "ratatouille", "spinach"]
  assert_equal(everyones_food, result)
end

  # 9. Find people with no friends
  # (hint: return an array, there might be more people in the future with no friends!)
def test_billy_nae_mates
  result = billy_nae_mates(@people)
  assert_equal(["Daphne"], result)
end
end 
